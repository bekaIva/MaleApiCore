...
namespace MaleApiCore.Services
{
    ...
    public class UnipayMerchant
    {
        ...
        public CreateOrderModel GenerateOrderCreateRequest(Order order)
        {
            ...
            om.BackLink = Convert.ToBase64String(Encoding.ASCII.GetBytes("http://bsoftstudio-001-site2.etempurl.com/CheckoutResult?MerchantOrderID=" + order.OrderId.ToString()));
            om.Mlogo = Convert.ToBase64String(Encoding.ASCII.GetBytes("http://bsoftstudio-001-site2.etempurl.com/images/ic_launcher.png"));
